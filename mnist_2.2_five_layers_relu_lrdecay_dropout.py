...
A1 = tf.nn.dropout(tf.nn.relu(tf.matmul(X_flat, W1) + b1), keep_prob=keep_prob)
A2 = tf.nn.dropout(tf.nn.relu(tf.matmul(A1, W2) + b2), keep_prob=keep_prob)
A3 = tf.nn.dropout(tf.nn.relu(tf.matmul(A2, W3) + b3), keep_prob=keep_prob)
A4 = tf.nn.dropout(tf.nn.relu(tf.matmul(A3, W4) + b4), keep_prob=keep_prob)
